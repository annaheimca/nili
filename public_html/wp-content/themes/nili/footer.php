...
<div id="footer" class="clearfix">
    ...
    <div id="footer-wrapper">
        ...
        <div class="grid col-300 fit powered">
            <a href="<?php echo esc_url(__('https://www.facebook.com/AnnaHeimGraphicDesign','responsive')); ?>" title="<?php esc_attr_e('Responsive Theme', 'responsive'); ?>">
                    <?php printf('OrAnna Digital Studios'); ?></a>
